...
class Memorialize extends StatefulWidget {
  Memorialize({Key key}) : super(key: key);

  @override
  _MemorializeState createState() => _MemorializeState();
}

class _MemorializeState extends State<Memorialize> {
  @override
  Widget memorializeNoTig() {
    return Container(
      child: Center(
        child: Text(
          "还没有备忘事，记得添加哦！",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: memorialize.length == 0
            ? memorializeNoTig()
            : memorializePage(context));
  }
}

Widget memorializePage(context) {
  return Container(
